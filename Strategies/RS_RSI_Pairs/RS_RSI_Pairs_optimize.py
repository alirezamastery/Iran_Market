...
if __name__ == '__main__':
    ...
    strats = cerebro.optstrategy(TestStrategy ,
                                 ma_period=range(50 , 55) ,
                                 rsi_period=range(5 , 10) , )
    ...
    for run in opt_runs:
        for strategy in run:
            ...
            final_balance = strategy.final_balance / 10
            profit = round(final_balance - (startcash / 10) , 2)
    ...
    sd.csvw(current_name , result , ['ma_period' ,
                                     'signal_threshold' ,
                                     'portfo' ,
                                     'rsi_period' ,
                                     'rsi_buy_level' ,
